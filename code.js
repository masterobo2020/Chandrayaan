...
if (mousePressedOver(stage1)) {
    ...
    for (var i=1; i<=50; i=i+1){
      star=createSprite(randomNumber(0,400),randomNumber(0,200));
...
if (mousePressedOver(stage4)) {
    ...
    moon.visible=true;
    stage5.visible=true;
    for (var t=1; t<=50; t=t+1){
      star=createSprite(randomNumber(0,400),randomNumber(0,200));
      star.setAnimation("star");
      starsG.add(star);
      stage5.depth=star.depth;
      stage5.depth+=1;
    }
}
...
if (mousePressedOver(stage5)) {
  ...
  //fill("white");
  //textSize(35);
  //text("You have successfully landed on the surface of the Moon!",200,200);
